...
var validate = function( itemToValidate, criteria, strict ){
...
module.exports.create = function(criteria, strict){
	return function( itemToValidate ){
		var self = this;
		self.criteria = criteria;
		self.strict = strict;
		return validate(itemToValidate,criteria,strict);
	}
};
